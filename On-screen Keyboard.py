...
copy = Button(root,fg = "white",text = "Copy",height = 2 ,width = 5,font = "Helvetica",bg = "grey36",command = copier )
copy.grid(row = 4 , column = 13,padx = 10,pady = 10)
